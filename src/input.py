...
def process_input(message, public, id_overwride = None):
    ...
    if command == "!add_friend":
        ...
        return_message = [user.send_friend_request(author_id, message.mentions[0].name), False]
        ...
        return_message = [user.remove_friend(author_id, message.mentions[0].name), False]
